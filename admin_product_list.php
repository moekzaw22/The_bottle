...
<head>
    ...
    <style>
        ...
        table td, table th { padding: 10px; border: 1px solid #ccc; text-align: center; }
        table th { background:#2c3e50;
    color:white; }
        ...
        .modal-content input { width: 100%; padding: 8px; margin: 5px 0 15px 0; border-radius: 5px; border: 1px solid #ccc; }
...
<form method="GET">
    ...
    <input type="text" name="txtproductname" class="input" placeholder="Find product..." value="<?= htmlspecialchars($search) ?>">
...
<?php if(mysqli_num_rows($query) > 0): ?>
    ...
    <tr>
        ...
        <td>
            <a href="#" onclick="openRestockModal(<?= $row['Product_id'] ?>)">Restock</a> | 
            <a href="productedit.php?PID=<?= $row['Product_id'] ?>">Edit</a> | 
